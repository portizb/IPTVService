package com.movistar.cordova.plugin.tvservices;
 ...
 * when low on memory.
 */
public class TvServices extends Service {
    ...
    public class ForegroundBinder extends Binder {
        TvServices getService() {
            // Return this instance of TvServices
            // so clients can call public methods
            return TvServices.this;
        }
    }
    ...
    private void keepAwake() {
        JSONObject settings = TvServicesPlugin.getSettings();
        ...
        wakeLock = powerMgr.newWakeLock(
                PowerManager.PARTIAL_WAKE_LOCK, "TvServicesPlugin");
    ...
    private Notification makeNotification() {
        return makeNotification(TvServicesPlugin.getSettings());
    }
